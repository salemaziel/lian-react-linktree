...
import Greenrbw from '../assets/images/greenrainbow.jpg'
import Jdog from '../assets/images/jamaicadog.jpg'
            ...
            {/**<h4>Gallery Title</h4>**/}
							...
							<div class="box alt">
								<div class="row gtr-50 gtr-uniform">
									<div class="col-6"><a href="#"><span class="image fit"><img src={Greenrbw} alt="" /></span></a></div>
									<div class="col-6"><a href="#"><span class="image fit"><img src={Jdog} alt="" /></span></a></div>
